      ...
      <div className='px-40 py-20 flex gap-5'>
        ...
        <div className='w-full flex flex-col gap-5 bg-neutral p-10 rounded-box shadow-xl'>
          <div className='flex flex-col gap-10 py-5'>
            ...
            <p className='w-1/3'>
              Add at least one phone number for the transfer ID so you can start transfering your
              money to another user.
            </p>
            <form
              onSubmit={handleSubmit(onSubmit)}
              className='flex flex-col items-center gap-5 mt-10'>
              {isError && <span className='text-error mt-2'>Failed to change phone number</span>}
              {isSuccess && (
                <span className='text-success mt-2'>Phone number changed successfully</span>
              )}
              <div className='w-1/3 input-group relative'>
                <span>
                  <Icon icon='material-symbols:phone-enabled' width='35' height='35' />
                </span>
                <input
                  name='phoneNumber'
                  type='tel'
              ...
              {errors.phoneNumber && (
                <span className='text-error mt-2'>{errors.phoneNumber?.message}</span>
              )}
              <button
                type='submit'
