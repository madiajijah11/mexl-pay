    ...
    <div className='bg-neutral rounded-box flex flex-col justify-between shadow-xl w-60 p-2'>
      <ul className='menu'>
        <li className='hover-bordered'>
          <Link href='/home'>
            <Icon icon='material-symbols:space-dashboard-outline-sharp' width='40' height='40' />
            Dashboard
          </Link>
        </li>
        <li className='hover-bordered'>
        ...
        <li className='hover-bordered'>
          <Link href='/profile'>
            <Icon icon='material-symbols:person-outline' width='40' height='40' />
            Profile
          </Link>
        </li>
      </ul>
      ...
      <div className='modal'>
        <div className='modal-box relative'>
          <label htmlFor='top-up' className='btn btn-sm btn-circle absolute right-2 top-2'>
            ✕
          </label>
